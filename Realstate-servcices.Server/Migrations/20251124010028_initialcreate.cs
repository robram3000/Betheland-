        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Agents_BaseMemberId", x => x.BaseMemberId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Clients_BaseMemberId", x => x.BaseMemberId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chats_Properties_PropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatParticipants_BaseMembers_RecipientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    RatingType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Service"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatingSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatingSchedules_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "BaseMemberId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RatingSchedules_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "BaseMemberId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RatingSchedules_ScheduleProperties_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "ScheduleProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatParticipants_RecipientId",
                table: "ChatParticipants",
                column: "RecipientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RatingSchedules_AgentId",
                table: "RatingSchedules",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_RatingSchedules_ClientId",
                table: "RatingSchedules",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_RatingSchedules_IsVisible_Status",
                table: "RatingSchedules",
                columns: new[] { "IsVisible", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_RatingSchedules_Rating",
                table: "RatingSchedules",
                column: "Rating");

            migrationBuilder.CreateIndex(
                name: "IX_RatingSchedules_RatingDate",
                table: "RatingSchedules",
                column: "RatingDate");

            migrationBuilder.CreateIndex(
                name: "IX_RatingSchedules_ScheduleId",
                table: "RatingSchedules",
                column: "ScheduleId",
                unique: true);
